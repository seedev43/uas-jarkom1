                    ...
                    <div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="<?php echo $base_url; ?>action/add/author.php">
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($hasil)) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="edit<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="POST" action="<?php echo $base_url; ?>action/update/author.php">
                                                                <div class=" modal-body">
                                                                    <div class="form-group mb-2">
                                                                        <label>Pengarang</label>
                                                                        <input type="text" class="form-control" name="author" value="<?php echo $row['name']; ?>" required>
                                                                    </div>
                                                ...
                                                <!-- end Modal -->
                                                <form style="display: inline-block;" method="POST" action="<?php echo $base_url; ?>action/delete/author.php" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
